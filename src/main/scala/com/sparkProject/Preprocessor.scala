...
object Preprocessor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark
      ...
      .csv("/Users/cochet/Documents/1_Work/TP_SPARK/DATAS/train.csv")
    ...
    dfFiltered.write.mode(SaveMode.Overwrite).parquet("/Users/cochet/Documents/1_Work/TP_SPARK/DATAS/prepared_trainingset")
